...
def write_model(model_path, input_base_path, model_size, num_pp):
    ...
    if model_size == "7B":
        raise NotImplementedError("7B model is not supported yet")
        # Unsharded
        # state_dict = {
    ...
    model.push_to_hub("orca13b_tinypar", private=True)
    tokenizer = AutoTokenizer.from_pretrained("huggyllama/llama-13b")
    tokenizer.push_to_hub("orca13b_tinypar", private=True)
